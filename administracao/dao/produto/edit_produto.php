<?php
    ...
    if($autorizado){
        ...
        if(empty($nome_final)){
            ...
            $delete = unlink($_UP['pasta'].$imagem_antiga);
            $upload = mysqli_query($conexao, "UPDATE produtos SET nome='$nome', descricao_curta='$descricao_curta', descricao_longa='$descricao_longa', preco='$preco', tag='$tag', description='$description', modificado=NOW(), categoria_id='$categoria_id', imagem='$nome_final', situacao_id='$situacao_id' WHERE id='$id' ");
        }
        //  echo " Nome: ".$nome." Curta: ".$descricao_curta." Longa: ".$descricao_longa." Preco: ".$preco." Tag: ".$tag." Description: ".$description." Categoria: ".$categoria_id." Imagem: ".$imagem." Situacao: ".$situacao_id."";

<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
    ...
    <a class="p-2 text-dark" href="http://<?php echo $_SERVER['SERVER_NAME']?>/about.php">Sobre nós</a>
    <a class="p-2 text-dark" href="http://<?php echo $_SERVER['SERVER_NAME']?>/contato.php">Contato</a>
    </nav>
